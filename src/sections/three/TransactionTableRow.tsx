...
export default function TransactionTableRow({
  ...
  const akunDebitDisplay = m_coa_debit?.nama_akun;
  const coaDebitCode = id_akun_debit;
  const akunKreditDisplay = m_coa_kredit?.nama_akun;
  const coaKreditCode = id_akun_kredit;
      ...
      <TableRow hover selected={selected}>
        ...
        <TableCell>
            <Label variant="soft" color="default">
                {coaDebitCode} - {akunDebitDisplay}
            </Label>
            <Label variant="soft" color="default">
                {coaKreditCode} - {akunKreditDisplay}
            </Label>
        </TableCell>
